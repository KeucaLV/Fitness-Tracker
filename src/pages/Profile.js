...
function Profile() {
    ...
    return (
        <>
            <div className="flex flex-col font-montserrat dark:bg-white overflow-x-hidden items-center h-screen bg-[#000000]">
                <SideBar active="profile" />
                <Header />
                <div className="flex relative flex-col  flex-wrap w-[90%] left-[50px] max-desktop:left-0">
                    <div className="flex flex-row">
                        <div className="flex flex-col justify-center flex-wrap flex-[50%] text-white ">
                            ...
                            <div className="flex w-full mt-6 justify-between items-center">
                                <Link to="/favouriteWorkouts" className="flex flex-wrap justify-center items-center hover:scale-[101%] hover:cursor-pointer ease-in-out duration-500">
                                    <img className="flex flex-[50%] brightness-[30%] max-w-[380px]" src={favouriteWorkout}/>
                                    <h1 className="flex absolute text-[30px]">Favourite Workout</h1>
                                </Link>
                                <Link to="/favouriteMeal" className="flex justify-center items-center hover:scale-[101%] hover:cursor-pointer ease-in-out duration-500">
                                    <img className="flex flex-[50%] brightness-[30%] max-w-[380px]" src={favouriteMeal}/>
                                    <h1 className="flex absolute text-[30px]">Favourite Meal</h1>
                                </Link>
                            </div>
                        </div>
                        <Leaderboard />
